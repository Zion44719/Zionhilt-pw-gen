...
document.getElementById("copyBtn").addEventListener("click", () => {
  const textToCopy = passwordDisplay.innerHTML;

  navigator.clipboard
    .writeText(textToCopy)
    .then(() => {
      alert("Text copied to clipboard!");
      console.log(passwordDisplay.innerHTML);
    })
    .catch((err) => {
...
// Password and copy Btn Display Functionality
const btnWrap = document.querySelector("#btn-wrapper");
const showBtn = document.querySelector("#showBtn");
// passwordDisplay.innerHTML !== "Your Password" ? btnWrap.style.display = "flex" : btnWrap.style.display = "none";
